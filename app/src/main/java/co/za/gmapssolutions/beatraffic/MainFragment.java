...
public class MainFragment extends Fragment implements ItemAdapter.ItemClickListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //direction icon
        directionIcon = view.findViewById(R.id.directionIcon);
        ...
        try {
            ...
            URL trafficUrl = new URL(HOST+":8080/traffic?id="+user.getId());
...
//            directionIcon.setImageResource(R.drawable.direction_arrive);
